...
PREDICATE_TO_WIKIDATA = {
    "locatedIn": WDT["P276"], "locate": WDT["P276"], "occupy": WDT["P276"], "storm": WDT["P276"],
    "settle": WDT["P276"], "flow": WDT["P276"], "conquer": WDT["P276"], "imprison": WDT["P276"],
    "build": WDT["P170"], "design": WDT["P170"], "construct": WDT["P170"], "paint": WDT["P170"],
    "make": WDT["P170"], "commission": WDT["P170"], "crown": WDT["P166"], "complete": WDT["P571"],
    "establish": WDT["P571"], "sign": WDT["P580"], "pledge": WDT["P580"], "choose": WDT["P580"],
    "designate": WDT["P31"],
}
...
PREDICATE_SEARCH_TERMS = {
    ...
    "crown": "award", "pledge": "date", "complete": "date", "choose": "date", "commission": "creator",
    "sign": "date", "storm": "location", "imprison": "location", "paint": "creator",
    "conquer": "location", "establish": "date", "make": "creator", "settle": "location",
...
PREDICATE_ALIGNMENT_FALLBACK = {
    ...
    "construct": (DC["creator"], "equivalent"), "own": (EDM["isShownAt"], "subProperty"),
    "occupy": (DCTERMS["spatial"], "equivalent"), "expand": (DCTERMS["modified"], "subProperty"),
    "crown": (DC["creator"], "subProperty"), "pledge": (DCTERMS["created"], "subProperty"),
    "complete": (DCTERMS["created"], "equivalent"), "choose": (DCTERMS["created"], "subProperty"),
    "commission": (DC["creator"], "equivalent"), "sign": (DCTERMS["created"], "equivalent"),
    "storm": (DCTERMS["spatial"], "equivalent"), "imprison": (DCTERMS["spatial"], "subProperty"),
    "paint": (DC["creator"], "equivalent"), "conquer": (DCTERMS["spatial"], "subProperty"),
    "establish": (DCTERMS["created"], "equivalent"), "make": (DCTERMS["created"], "equivalent"),
    "settle": (DCTERMS["spatial"], "equivalent"), "flow": (DCTERMS["spatial"], "subProperty"),
    "grow": (DCTERMS["modified"], "subProperty"), "designate": (DCTERMS["type"], "equivalent"),
...
def main():
    ...
    print(f"Updated alignment to {config.ALIGNMENT_FILE}")
