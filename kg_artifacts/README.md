...
- **`kb_expanded.nt`** — Expanded KB (N-Triples). May be omitted from Git due to size; run `python run_pipeline.py` from the repo root to regenerate (requires `EUROPEANA_API_KEY`).
