  ...
  \textbf{Screenshots.} Figure~\ref{fig:rag_screenshot} shows the script running with two representative examples: ``Which items are linked to Romania?'' and ``What places are associated with Bucharest?''. The CLI displays the baseline answer, then the SPARQL query used, and the result rows (up to 20 shown, with total count).
  ...
  \small
  \begin{verbatim}
Question (or 'quit'): Which items are linked to Romania?
...
[Results]
item
https://www.europeana.eu/item/1442/Cronica_1021
https://www.europeana.eu/item/1442/Cronica_1132
... (showing 20 of 2130)

Question (or 'quit'): What places are associated with Bucharest?
[Results] place | item
lh:Bucharest | https://www.europeana.eu/item/...
  \end{verbatim}
  \end{minipage}}
