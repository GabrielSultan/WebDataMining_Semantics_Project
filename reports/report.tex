...
The row for 91,955 triples matches \texttt{kg\_artifacts/kge\_splits/transe\_result/results.json} (\texttt{metrics.both.optimistic}). Subsample rows are from separate training runs in the notebook. Performance increases with KB size; small KBs produce unstable embeddings.
